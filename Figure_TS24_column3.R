# THIS SCRIPT REPRODUCES COLUMN 3 OF FIGURE TS.24 (IPCC-WGI AR6).
...
# Function to compute model agreement -------------------------------------------------------
...
local_path = "final_data/" # path to netCDF data

# set working directory
setwd(local_path)

### Loading vectorial Spatial Objects for map plotting ------------------------------------------------------------------------------
# Coast
...
grid <- loadGridData(paste0("./CORDEX_TX35_", scenario, "_", period, "_rel.to-1995-2014.nc"), var = "tx35isimip")
